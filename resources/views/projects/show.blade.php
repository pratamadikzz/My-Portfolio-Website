        ...
        <nav class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('projects') }}"
                    class="rounded-full border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 px-4 py-2 text-xs font-semibold text-slate-700 dark:text-white shadow-sm transition hover:border-slate-300 hover:bg-slate-100 dark:hover:bg-white/10">
                    ← All Projects
                </a>
    ...
    <main>
        ...
        <section class="border-t border-slate-200/80 dark:border-white/5 px-6 py-20">
            <div class="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <a href="{{ route('projects') }}"
                    class="inline-flex items-center gap-2 rounded-full bg-slate-900 px-7 py-3.5 text-xs font-bold text-white shadow-md transition hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100">
