@php
    $projects = [
        ...
        [
            'title' => 'Sistem Informasi Pemetaan Fasilitas Umum',
            'category' => 'information',
        ...
        [
            'title' => 'AI CV & Portfolio Analyzer',
            'category' => 'ai',
        ...
        [
            'title' => 'Competition Management Platform',
            'category' => 'management',
        ...
        [
            'title' => 'Vehicle Document Management System',
            'category' => 'management',
        ...
        [
            'title' => 'PPE Distribution Management System',
            'category' => 'management',
...
<head>
    ...
    <meta name="description"
        content="All projects and engineering portfolio of Andhika Pratama, Web Developer and Information Systems Student.">

    <title>All Projects — Andhika Pratama</title>
    ...
    <style>
        ...
        body.light-mode .project-filter.active-filter {
            background-color: #0f172a !important;
            color: #ffffff !important;
            border-color: #0f172a !important;
        }

        body.light-mode .project-filter:not(.active-filter) {
            background-color: #ffffff !important;
            color: #475569 !important;
        ...
        body.dark-mode .project-filter.active-filter {
            background-color: #ffffff !important;
            color: #08090D !important;
            border-color: #ffffff !important;
        }

        body.dark-mode .project-filter:not(.active-filter) {
            background-color: rgba(255, 255, 255, 0.03) !important;
            color: #94a3b8 !important;
            border-color: rgba(255, 255, 255, 0.1) !important;
        }

        body.dark-mode #project-search {
            background-color: rgba(255, 255, 255, 0.04) !important;
            color: #ffffff !important;
            border-color: rgba(255, 255, 255, 0.12) !important;
        }

        body.dark-mode #project-search::placeholder {
            color: #64748b !important;
        }
...
<body
    ...
    <main>
        <!-- Hero Header -->
        <section class="px-6 pb-14 pt-36">
        ...
        <section
            ...
            <div class="mx-auto flex max-w-6xl flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="relative w-full lg:w-72">
                    <input id="project-search" type="search" placeholder="Search projects by name..."
                        class="w-full rounded-full border border-slate-200 bg-white px-5 py-2.5 text-xs font-medium text-slate-900 shadow-sm outline-none placeholder:text-slate-400 transition focus:border-blue-500 dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder:text-gray-500">
                </div>
                ...
                @foreach ($projects as $project)
                    <article
                        ...
                        <div class="p-6">
                            ...
                            <p class="mt-2 text-xs leading-relaxed text-slate-600 dark:text-gray-400 line-clamp-2">
                                {{ $project['description'] }}
                            </p>
                            ...
                            <div
                                ...
                                @else
                                    <span class="text-[11px] font-semibold text-slate-400 dark:text-gray-500">
                                        Concept Project
                                    </span>
                                @endif
                            </div>
